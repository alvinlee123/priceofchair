...
class Store(object):
    ...
    def find_by_url(cls,url):
        """
        Return a store from a url like "http://www.johnlewis.com/item/sdf4asdf
        :param url: The item's URL
        :return: a Store, or raisers a StoreNotFoundException if no store matches the URL
        """
        ...
        for i in range(0,len(url)+1):
            try:
                ...
                raise StoreErrors.StoreNotFoundException("URL prefix used to find stores didn't provide results")